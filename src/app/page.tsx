...
import MyReferrels from '@/components/MyReferrels';
  ...
  return (
    <main className='overflow-hidden block'>
      <section className=' h-screen  overflow-hidden flex items-center space-y-10 flex-col justify-center '>
        ...
        <h1 className='font-clashDisplayMedium tracking-widest text-center text-4xl px-2 sm:p-0 sm:text-6xl '>
          Welcome to visit my portfolio
        </h1>
        <div className=' sm:items-center  w-2/3 gap-10 sm:gap-0 lg:w-1/3 flex flex-col sm:flex-row items-start sm:justify-between '>
