...
export default function Services() {
  ...
  return (
    <AnimatePresence>
      <section
        id='services'
        className='h-full w-screen pt-36 sm:pt-28 px-10 sm:px-24 flex flex-col'
      >
        {/* Header Section */}
          ...
          <div className='flex flex-col  sm:w-2/4 justify-between h-[80vh] items-start'>
            ...
            <div className='flex flex-col-reverse w-full  sm:h-2/4 justify-between'>
              <div className='bg-white  w-full flex items-center sm:gap-4 rounded-full px-4 py-2 shadow-lg max-w-lg'>
                ...
                <button
                  type='button'
                  className={`py-2 px-2 font-satoshiBold tracking-wider rounded-full transition ${
                    serviceInput ? 'bg-green-500' : 'bg-gray-600 cursor-not-allowed'
                  }`}
                ...
                >
                  <Image
                    ...
                    ${serviceInput ? 'opacity-100 ' : 'opacity-70'}
                    `}
