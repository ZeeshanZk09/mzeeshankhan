...
function Hero() {
  return (
    <section
      id='hero'
      className='flex flex-col md:flex-row-reverse items-center min-h-screen justify-between bg-[aliceblue] py-28  px-6 md:px-10 '
    >
      {/* Image Section */}
      <div className='justify-self-end '>
        <div className=' w-full  md:w-1/2 flex flex-col items-center  lg:items-start '>
          <div className='hero-img w-48  h-48 md:w-72 md:h-72 lg:w-96 lg:h-96 rounded-full border-2 border-t-slate-400 border-b-[#04AF70] border-r-[#04AF70] border-l-[#04AF70] shadow-black shadow-inner -z-50'></div>
