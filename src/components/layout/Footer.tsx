...
export default function Footer() {
  return (
    <AnimationWrapper>
      <footer className='bg-gray-100  flex flex-col   overflow-x-hidden w-screen min-h-screen h-fit text-black '>
        {/* Logo and navigation */}
        ...
        <div className='flex flex-col w-screen items-start px-10 sm:px-24 my-5 gap-4'>
          <h2 className='font-clashDisplayMedium text-xl tracking-widest'>Personal Information:</h2>
          <ul className='w-full'>
          ...
          <h2 className='font-clashDisplayMedium text-xl tracking-widest'>Address:</h2>
          <p className='font-satoshiRegular'>
            Police Flats/ Block B/ Flat #3, Sindh, Karachi - Baldia Town, Saeedabad, behind police
            station
          </p>
        </div>
        {/* Copyright text */}
